...
public:
    ...
    virtual bool onKey(SDL_Event &event, std::shared_ptr<PhysicsComponent> comp = nullptr);                   // The function should return true, if the key event is consumed. This prevents other components to receive the event.
